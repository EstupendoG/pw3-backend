...
var CityRepository = /** @class */ (function () {
    ...
    CityRepository.prototype.create = function (city) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prismaClient_1.default.city.create({
                            data: {
    ...
    CityRepository.prototype.update = function (id, data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ctr_id = data.ctr_id, resto = __rest(data, ["ctr_id"]);
                        updateData = __assign({}, resto);
                        if (ctr_id !== undefined) {
                            updateData.ctr_id = { set: ctr_id };
                        }
                        return [4 /*yield*/, prismaClient_1.default.city.update({
                                where: { cty_id: id },
                                data: data
                            })];
                    case 1:
    ...
    CityRepository.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prismaClient_1.default.city.delete({
                            where: { cty_id: id }
                        })];
                    case 1:
                        deleted = _a.sent();
