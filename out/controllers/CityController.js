...
// CREATE
var createCity = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, nome, populacao, latitude, longitude, id_pais, result, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, nome = _a.nome, populacao = _a.populacao, latitude = _a.latitude, longitude = _a.longitude, id_pais = _a.id_pais;
                return [4 /*yield*/, service.create(String(nome), clearNumber(populacao), clearNumber(latitude), clearNumber(longitude), clearNumber(id_pais))];
            case 1:
                result = _b.sent();
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                id = Number(req.params.id);
                _a = req.body, nome = _a.nome, populacao = _a.populacao, latitude = _a.latitude, longitude = _a.longitude, id_pais = _a.id_pais;
                return [4 /*yield*/, service.update(id, String(nome), Number(populacao), Number(latitude), Number(longitude), Number(id_pais))];
            case 1:
                response = _b.sent();
