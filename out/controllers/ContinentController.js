...
// CREATE
var createContinent = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, nome, descricao, result, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, nome = _a.nome, descricao = _a.descricao;
                return [4 /*yield*/, service.create(nome, descricao)];
            case 1:
                result = _b.sent();
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                id = Number(req.params.id);
                _a = req.body, nome = _a.nome, descricao = _a.descricao;
                return [4 /*yield*/, service.update(id, nome, descricao)];
            case 1:
                result = _b.sent();
                return [2 /*return*/, res.status(201).json(result)];
            case 2:
